  ...
  return (
    <div className={styles.main}>
      ...
      <p>
        ...
        регулирует отношения между ИП Кривошеиным Ярославом Петровичем, ОГРНИП:
        321723200036962, ИНН: 451501513311 (далее - Администратор) и
        пользователями сайта on-wifi.ru (далее - Сайт).
      </p>
      <p>
        1.2. Пользовательское соглашение является публичной офертой.
        Пользователь, регистрируясь на Сайте или используя его ресурсы, выражает
      ...
      <ul>
        <li>
          ...
          оскорбительного, порнографического или иного противоправного контента;
        </li>
      ...
      <p>
        3.1. Администратор обязуется обеспечивать функционирование Сайта и его
        доступность для пользователей.
      </p>
      <p>3.2. Администратор имеет право:</p>
      <ul>
        <li>
          Изменять содержание Сайта и условия предоставления услуг в любое время
      ...
      <p>
        4.1. Пользователь несет ответственность за достоверность и законность
        размещаемой на Сайте информации.
      </p>
      <p>
        4.2. Администратор не несет ответственности за любой ущерб, возникший в
      ...
      <p>
        5.2. В случае возникновения споров, связанных с исполнением Соглашения,
        стороны обязуются разрешать их путем переговоров. Если спор не может
        быть разрешен путем переговоров, он подлежит рассмотрению в суде по
        месту нахождения Администратора.
      </p>
      <p>
